    ...
    <section className="relative overflow-hidden px-6 py-24 text-center text-white">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mx-auto mb-10 max-w-2xl text-lg text-white/75 md:text-xl">
          Bar-IQ helps bars track inventory faster, reduce shrinkage, and manage
          stock easily.
        </p>

        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          <button className="rounded-xl bg-linear-to-r from-blue-500 to-blue-400 px-8 py-4 text-lg font-medium text-white shadow-[0_0_35px_rgba(59,130,246,0.35)] transition hover:scale-[1.02]">
            Start Inventory
          </button>
